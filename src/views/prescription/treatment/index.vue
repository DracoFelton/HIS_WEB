  ...
  <div class="app-container">
    ...
    <div id="content" class="filter-container" :hidden="is_content_hidden">
      <el-form ref="form" :model="form" label-width="80px">
        ...
        <el-form-item v-model="form.price" label="诊疗总数">{{ form.number }}</el-form-item>
        <el-form-item>
          <el-button type="primary" @click="obSubmit">确认诊疗</el-button>
...
export default {
  ...
  data() {
    return {
      ...
      drugs: [{ 'code': '16979474000208', 'name': 'ABO血型鉴定', 'format': '1次', 'form': '检验科' },
        { 'code': '16979474000209', 'name': 'CT', 'format': '1次', 'form': '放射科' },
        { 'code': '16979474000208', 'name': '透视', 'format': '1次', 'form': '胸外科' }
      ]
    }
  },
  methods: {
