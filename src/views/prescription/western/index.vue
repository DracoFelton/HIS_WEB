      ...
      >
        <el-form :inline="true" class="demo-form-inline" :model="form_dig">
          ...
          <el-table :data="drugs" style="width: 100%">
            ...
            <el-table-column prop="name" label="药名" width="160" />
            <el-table-column prop="format" label="剂量" />
            <el-table-column prop="way" label="用法用量" width="180" />
...
export default {
  ...
  data() {
    return {
      ...
      drugs: [{ 'code': '86979474000208', 'name': '布洛芬片', 'format': '50mg/片', 'way': '口服 3片/次 5日', 'number': '45' },
        { 'code': '86979474000209', 'name': '氨茶碱片', 'format': '50mg/片', 'way': '口服 2片/次', 'number': '24' },
        { 'code': '86979474000208', 'name': '50%葡萄糖注射液', 'format': '20ml/1支', 'way': '', 'number': '12' },
        { 'code': '86979474000209', 'name': '盐酸特比萘芬泡腾片', 'format': '50mg/片', 'way': '外用 1次/日', 'number': '30' }
      ]
    }
  },
  methods: {
